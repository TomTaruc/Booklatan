...
public class UserMemberDAO extends DataAccessObject{
    ...
    public UserMemberDAO() throws Exception {};
    ...
    public ArrayList<Member> getMembers (Member.MembershipStatus status) throws SQLException {
        con = super.getConnection();
        Member member;
        members.clear(); // removes previous selection
    ...
    public ArrayList<Member> getMembers (String search, Member.MembershipStatus status) throws SQLException{
        con = super.getConnection();
        Member member;
        members.clear(); // Removes previous selection
